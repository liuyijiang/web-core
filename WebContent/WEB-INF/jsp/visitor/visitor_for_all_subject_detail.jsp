        ...
        <span><i class="icon-time"></i>Create Time:${subjectEntity.createTime }</span>
         <span class="pull-right">
           ...
           <c:if test="${!empty partShowResponse.joiner }">
              <a href="javascript:;"><small>等${subjectEntity.joinpeople }人参与</small></a>
           </c:if>
         </span>
        <br />
     </div>
...
<br /><br /><br />
    ...
    <div id="createPartModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    ...
	    <div class="modal-footer">
	      <a href="javascript:;" class="btn btn-primary" onclick="ajaxFileUpload('${subjectEntity.id }','${subjectEntity.tags }','${subjectEntity.name }')">发布</a>
