       	...
       	<div class="navbar">
			<div class="navbar-inner form-inline ">
			     ...
			     <span class="pull-right">
				     ...
				     <ul class="dropdown-menu">
					       <li><a href="javascript:;" onclick="showTextCommecnt()"><i class="icon-comment-alt"></i>评论${partEntity.comments }</a></li>
						   <li><a href="javascript:;" onclick="showVoiceComment()"><i class="icon-volume-off"></i>音评${partEntity.audios }</a></li>
		               </ul>
				    </div>
			     </span>
			</div>
